...
Why would you remember an interrupted task more than the completed one? The explanation put forward by Zeigarnik Effect is, if a task is not completed, a state of tenstion is created and the 
<Dictionary 
word="quasi-need" 
